...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form method="post" action="<?= base_url()?>transaksirakha/simpan">
                    ...
                    <div class="form-group">
                       <input type="text" name="" id="harga" class="form-control" placeholder="Harga Paket" readonly>
                    </div> 
                    ...
                    <div class="form-group">
                        <select name="bayar" class="form-control">
                            ...
                            <option value="Belum Lunsa">Belum Lunas</option>
                        </select>
                    </div> 
                    <div class="form-group" hidden >
                    ...
                    <div class="form-group">
                       ...
                       <a h ref="<?= base_url()?>konsumenrakha" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    $('#paket').change(function(){
        ...
        $.ajax({
            url : '<?= base_url()?>transaksirakha/getHargaPaket',
