...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form method="post" action="<?= base_url()?>transaksirakha/update">
                       ...
                       <select name="kode_paket" id="paket" class="form-control" required>
                        <?php
                                    foreach ($paket as $pkt) {
                                        if ($transaksi['paket'] == $pkt->kode_paket) {?>
                    ...
                    <div class="form-group">
                       ...
                       <a href="<?= base_url()?>transaksirakha/riwayat" class="btn btn-danger">Batal</a>
                    </div>
                </form>
            </div>
        </div>
